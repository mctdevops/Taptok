...
//  Taptok
//
//  Created by Mehul Nahar on 29/07/22.
//
...
struct OrganizationSettings: View {
    ...
    @StateObject var model = WebViewModel(requestURL: AppConfig.OrganizationSettings)
...
struct OrganizationSettings_Previews: PreviewProvider {
    static var previews: some View {
        OrganizationSettings().environmentObject(TaptokDataManager())
    }
}
